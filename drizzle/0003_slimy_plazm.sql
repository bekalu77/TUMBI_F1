CREATE TABLE `jobs` (
	...
	`deadline` integer,
	`created_at` integer DEFAULT '"2025-10-28T13:37:46.100Z"',
...
CREATE TABLE `__new_companies` (
	...
	`created_at` integer DEFAULT '"2025-10-28T13:37:46.097Z"',
	`company_type` text,
...
CREATE TABLE `__new_items` (
	...
	`description` text,
	`image_urls` text,
	`created_at` integer DEFAULT '"2025-10-28T13:37:46.099Z"',
	FOREIGN KEY (`company_id`) REFERENCES `companies`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON UPDATE no action ON DELETE no action,
